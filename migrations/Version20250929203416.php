 ...
 */
final class Version20250929203416 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD COLUMN reset_token VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD COLUMN reset_token_expires_at DATETIME DEFAULT NULL');
    }
}
